            ...
            <div class="row page-bg">
                <div class="p-4 col-md-12">
                    <div class="text-center top-icon">
                        ...
                        <form id="form-login" action="<?php echo e(route('pengumuman.buat-data')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div>
...
unset($__errorArgs, $__bag); ?>" name="isi" type="text"
                                       placeholder="Isi" value="<?php echo e(old('isi')); ?>" >
                            </div>
...
<?php /**PATH D:\Sem 6\PBKK\HeadHurt\latihanpbkk\resources\views/create-data.blade.php ENDPATH**/ ?>