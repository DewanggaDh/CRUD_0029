                        ...
                        <?php endif; ?>
                            ...
                            <div>
                                <input class="mt-3 form-control form-control-lg" name="title" type="text"
                                       placeholder="Title" value="<?php echo e($data->title ? $data->title : 'Tidak Ada Data'); ?>" readonly>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <input class="mt-3 form-control form-control-lg" name="isi" type="text"
                                       placeholder="Isi" value="<?php echo e($data->isi ? $data->isi : 'Tidak Ada Data'); ?>" readonly>
                            </div>
...
unset($__errorArgs, $__bag); ?>
 ...
 <?php /**PATH D:\Sem 6\PBKK\HeadHurt\latihanpbkk\resources\views/detail-data.blade.php ENDPATH**/ ?>